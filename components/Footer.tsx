    ...
    <footer className="bg-background-card border-t border-primary/20 mt-auto">
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* About */}
          <div>
            <h3 className="text-lg font-bold gradient-text mb-4">AetherCrown98</h3>
            <p className="text-gray-400 text-sm">
              Autonomous AI-driven business empire powered by cutting-edge technology.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li className="text-gray-400">Payment Processing</li>
            </ul>
          </div>
        ...
        <div className="mt-8 pt-8 border-t border-primary/20 text-center text-gray-400 text-sm">
          <p>&copy; 2025 AetherCrown98. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
