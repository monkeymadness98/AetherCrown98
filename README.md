...
API Documentation: [http://localhost:8000/docs](http://localhost:8000/docs) (auto-generated by FastAPI)
...
See [backend/README.md](backend/README.md) for detailed API documentation and [DEPLOYMENT.md](DEPLOYMENT.md) for deployment instructions.
